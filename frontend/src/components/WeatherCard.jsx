    ...
    <div className="weather-card">
      ...
      <div className="weather-main">
        <div className="temperature">
          ...
          <span className="feels-like">Feels like: {Math.round(data.feels_like)}°C</span>
        </div>
      ...
      <div className="weather-details">
        <div className="detail-item">
          ...
          <span className="detail-value">{Math.round(data.temp_min)}°C</span>
        </div>
        <div className="detail-item">
          <span className="detail-label">Max Temp</span>
          <span className="detail-value">{Math.round(data.temp_max)}°C</span>
        </div>
        <div className="detail-item">
